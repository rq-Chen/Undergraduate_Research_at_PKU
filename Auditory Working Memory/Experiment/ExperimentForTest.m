...
try
    ...
    PROMPTS{1, 6} = ['ready for the main tasks?',...
        ...
        PROMPTS{1, 1, 9} = '如果准备好了，请按下空格键；如果有疑问,请向右上方挥手';
        ...
        PROMPTS{1, 2, 9} = '如果准备好了，请按下空格键；如果有疑问,请向右上方挥手';
        ...
        PROMPTS{1, 3, 9} = '如果准备好了，请按下空格键；如果有疑问,请向右上方挥手';
        ...
        PROMPTS{1, 4, 9} = '如果准备好了，请按下空格键；如果有疑问,请向右上方挥手.';
    ...
    for iblock = iblock : iblock + NBLOCKS - 1
        ...
        if keyCode(keyend)
            for iiii = 1:100
                fprintf('the subject is calling!!!\n');
            end
            [~, ~,keyCode] = KbCheck;
        ...
        if countblock ~= 8 
            ...
            drawTextAt(w,double('现在休息。如果想要继续，请按下空格键'),cx,cy ,[255 255 255]);
